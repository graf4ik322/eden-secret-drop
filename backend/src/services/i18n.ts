...
export const i18nDefaults: Record<string, Record<string, unknown>> = {
  en: {
    ...
    profile: { title: 'Profile', member: 'Member', admin: 'Admin', language: 'Language', memberSince: 'Member Since', selectLanguage: 'Select Language', languages: { ru: 'Русский', en: 'English' } },
  ...
  ru: {
    ...
    profile: { title: 'Профиль', member: 'Участник', admin: 'Администратор', language: 'Язык', memberSince: 'В сообществе с', selectLanguage: 'Выберите язык', languages: { ru: 'Русский', en: 'English' } },
