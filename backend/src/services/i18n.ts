...
export const i18nDefaults: Record<string, Record<string, unknown>> = {
  ...
  ru: {
    ...
    profile: { title: 'Профиль', member: 'Участник', admin: 'Админ', userId: 'ID пользователя', username: 'Имя пользователя', language: 'Язык', memberSince: 'Участник с', memberSinceDate: 'Июль 2026', languages: { ru: 'Русский', en: 'English' }, selectLanguage: 'Выберите язык', notifications: 'Уведомления', about: 'О приложении' },
