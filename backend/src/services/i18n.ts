...
export const i18nDefaults: Record<string, Record<string, unknown>> = {
  en: {
    ...
    profile: { title: 'Profile', member: 'Member', admin: 'Admin', userId: 'User ID', username: 'Username', language: 'Language', languages: { ru: 'Русский', en: 'English' }, selectLanguage: 'Select Language', notifications: 'Notifications', about: 'About' },
  ...
  ru: {
    ...
    drop: { live: 'В ПРОДАЖЕ', sold: 'ПРОДАНО', limited: 'ЛИМИТИРОВАНО', priceOnRequest: 'Цена по запросу', description: 'Описание', specifications: 'Характеристики', brand: 'Бренд', category: 'Категория', views: 'просмотров', published: 'Опубликовано {{hours}} ч. назад', publishedLessThanHour: 'Опубликовано менее часа назад', publishedHour: 'Опубликовано 1 час назад', trust: { original: 'Оригинал', warranty: 'Гарантия', verified: 'Верифицировано', fastDelivery: 'Быстрая доставка' }, shareText: '🔥 {{title}} \u2014 \u20ac{{price}}' },
    profile: { title: 'Профиль', member: 'Участник', admin: 'Админ', userId: 'ID пользователя', username: 'Имя пользователя', language: 'Язык', languages: { ru: 'Русский', en: 'English' }, selectLanguage: 'Выберите язык', notifications: 'Уведомления', about: 'О приложении' },
